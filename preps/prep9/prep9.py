...
class BinarySearchTree:
    ...
    def items(self) -> List:
        ...
        if self.is_empty():
            ...
            listed.extend(self._left.items())
            listed.extend(self._root)
            listed.extend(self._right.items())
        return listed
    ...
    def smaller(self, item: Any) -> List:
        ...
        listed = self.items()
        index = 0
        while index < len(listed) and item > listed[index]:
            index += 1
        return listed[:index]
